...
const groups = {
  ...
  skill_registry_schema: [
    ...
    ["wikibrowser/scripts/check-skill-registry.mjs", "approveSkillProposal|previewApplyProposalDiff|previewProposal"],
    ["wikibrowser/scripts/check-skill-registry.mjs", "skill..v1"],
    ["skill-registry-web/scripts/check-skill-registry-web.mjs", "expectedEtag"],
