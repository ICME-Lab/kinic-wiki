...
- The `Stop` hook saves Codex turn transcripts to local pending storage first, then writes session evidence under `/Sources/sessions/codex/...` with `kinic-vfs-cli` on a best-effort basis.
