...
description: Record Kinic Skill Registry run evidence after a Codex skill materially affects a task outcome. Use when the user asks to record or preserve skill evidence from Codex.
---
