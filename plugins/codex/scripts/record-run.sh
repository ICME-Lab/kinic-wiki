#!/usr/bin/env bash
# Where: plugins/codex/scripts/record-run.sh
# What: Record Codex skill run evidence through kinic-vfs-cli.
# Why: Codex uses a skill-only plugin; Kinic CLI owns DB writes and job creation.
set -euo pipefail
