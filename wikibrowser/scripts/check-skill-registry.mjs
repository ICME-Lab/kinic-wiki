...
assert.match(client, /getCreditsConfig/);
assert.match(client, /databaseCreditsDisabledReason/);
assert.match(client, /const writable = databaseCanWrite\(databaseSummary, creditsConfig\)/);
...
assert.match(client, /setCreditsConfig\(await getCreditsConfig\(canisterId\)\)/);
