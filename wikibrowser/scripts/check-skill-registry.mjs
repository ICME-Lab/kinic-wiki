...
assert.match(client, /getBillingConfig/);
assert.match(client, /databaseBillingDisabledReason/);
assert.match(client, /const writable = databaseCanWrite\(databaseSummary, billingConfig\)/);
