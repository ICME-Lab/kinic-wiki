...
assert.match(dashboardClient, /listDatabaseCyclePendingOperationsAuthenticated/);
assert.match(dashboardClient, /identity && nextDatabase\?\.role === "owner"/);
assert.match(dashboardClient, /nextDatabase\.status === "active"/);
assert.match(dashboardClient, /<PendingDatabasePanel[^>]*pendingOperationCount=\{pendingOperationCount\}/);
...
assert.match(dashboardUi, /pendingOperationCount: number;/);
assert.match(dashboardUi, /pendingOperationCount=\{props\.pendingOperationCount\}/);
