...
assert.match(homePage, /principalBillingSummaryAuthenticated/);
assert.match(homePage, /topUpPrincipalBalanceAuthenticated/);
assert.match(homePage, /withdrawPrincipalBalanceAuthenticated/);
assert.match(homePage, /listPrincipalBillingEntriesAuthenticated/);
assert.match(homePage, /Display name/);
assert.match(homePage, /Top up principal/);
assert.match(homePage, /principal top-up e8s/);
assert.match(homePage, /destination principal/);
...
assert.match(dashboardClient, /renameDatabaseAuthenticated/);
assert.match(dashboardClient, /topUpDatabaseAuthenticated/);
assert.match(dashboardClient, /withdrawDatabaseBalanceAuthenticated/);
assert.match(dashboardClient, /listDatabaseBillingEntriesAuthenticated/);
assert.match(dashboardClient, /BillingLedgerTable/);
assert.match(dashboardClient, /DB top-up e8s/);
assert.match(dashboardClient, /DB withdraw e8s/);
...
assert.match(homePage, /await authClient\.logout\(\);[^]*setPrincipal\(null\);[^]*setPrincipalBilling\(null\);[^]*setPrincipalEntries\(\[\]\);[^]*setCreatedDatabaseId\(null\);[^]*setError\(null\);[^]*setPublicError\(null\);[^]*await refreshDatabases\(null\);/);
