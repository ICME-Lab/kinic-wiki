...
assert.match(adminHeader, /href="\/" aria-label="Back to home"/);
...
assert.match(homePageClient, /const databaseRefreshClient = principal && authClient \? authClient : null;/);
assert.match(homePageClient, /void refreshDatabases\(databaseRefreshClient\);/);
assert.match(homePageClient, /\}, \[authClient, authReady, authRefreshSeq, principal, refreshDatabases\]\);/);
...
assert.match(homePageClient, /const createUnavailable = !principal \|\| loadState === "loading" \|\| walletBusyProvider !== null \|\| walletBalanceLoading \|\| !walletReadyToFundCreate;/);
...
assert.match(homePageClient, /iiConnected: boolean;/);
assert.match(homePageClient, /return "Connect Internet Identity"/);
assert.match(homePageClient, /return "Connect OISY or Plug"/);
...
assert.match(homePageClient, /const createDatabaseAction = \(/);
assert.match(homePageClient, /<DatabaseBody createDatabaseAction=\{createDatabaseAction\}/);
assert.match(homePageClient, /\{createDatabaseAction\}\s*<\/div>\s*<DatabaseBody createDatabaseAction=\{createDatabaseAction\}/);
