...
assert.match(wallet, /function paymentAmountE8sForCredits/);
...
assert.match(wallet, /oisyCallCreditPurchase\(connection\.wallet, connection\.owner, request\)/);
assert.match(wallet, /contentMap|Certificate|requestIdOf/);
assert.match(wallet, /purchase_database_credits\(request\.databaseId, request\.credits\)/);
