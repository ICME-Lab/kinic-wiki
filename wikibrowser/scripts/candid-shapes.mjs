export const expectedTypes = {
  ...
  ResultSmtPolicy: { kind: "variant", cases: { Ok: "opt SmtPolicySnapshot", Err: "text" } },
  ResultSetSmtPolicy: { kind: "variant", cases: { Ok: "SetSmtPolicyResult", Err: "text" } },
  ...
  SetSmtPolicyResult: { kind: "record", fields: { policy: "SmtPolicySnapshot" } },
  SmtPolicySnapshot: {
    kind: "record",
    fields: {
      smt_lib_hash: "text",
      ...
      created_at_ms: "int64",
      version: "text",
      source_refs: "vec SmtPolicySourceRef",
      normalized_ast_hash: "text",
      icme_policy_hash: "opt text",
      compiler_version: "opt text",
      icme_policy_id: "opt text"
    }
  },
  SmtPolicySourceRef: {
    kind: "record",
...
export const expectedMethods = {
  ...
  clear_database_smt_policy: { input: ["text", "opt text"], output: "ResultUnit", mode: "update" },
  clear_operator_smt_policy: { input: ["opt text"], output: "ResultUnit", mode: "update" },
  ...
  get_database_smt_policy: { input: ["text"], output: "ResultSmtPolicy", mode: "query" },
  get_operator_smt_policy: { input: [], output: "ResultSmtPolicy", mode: "query" },
  ...
  set_database_smt_policy: { input: ["text", "SmtPolicyUploadRequest", "opt text"], output: "ResultSetSmtPolicy", mode: "update" },
  set_operator_smt_policy: { input: ["SmtPolicyUploadRequest", "opt text"], output: "ResultSetSmtPolicy", mode: "update" },
