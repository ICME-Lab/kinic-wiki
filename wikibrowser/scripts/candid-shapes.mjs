...
export const didTypeAliases = {
  ...
  ResultSourceEvidence: "Result_13",
...
export const expectedMethods = {
  ...
  store_manifest: { input: ["DatabaseIdRequest"], output: "ResultStoreManifest", mode: "query" },
  ...
  memory_recall: { input: ["QueryContextRequest"], output: "ResultQueryContext", mode: "query" },
  ...
  knowledge_evidence: { input: ["SourceEvidenceRequest"], output: "ResultSourceEvidence", mode: "query" },
