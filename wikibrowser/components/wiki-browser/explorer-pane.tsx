...
import { ArrowDownAZ, Check, Ellipsis, FileInput, FilePlus, FolderInput, FolderPlus, History, MoveRight, Pencil, RotateCcw, Trash2, X } from "lucide-react";
...
import type { ChildNode, DatabaseRole, DeletedNodeSummary, WikiNode } from "@/lib/types";
    ...
    <div className="flex items-center gap-1">
      ...
      <DropdownMenu>
        ...
        <DropdownMenuContent align="end">
          ...
          <DropdownMenuItem disabled={deletedDisabled} onSelect={onDeleted}>
