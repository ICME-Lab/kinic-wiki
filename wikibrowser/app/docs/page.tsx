...
// Why: Clipper, CLI, Canister API, and Skills docs need one stable entrypoint.
...
export const metadata: Record<string, unknown> = {
  ...
  description: "Documentation for Kinic Wiki Clipper, CLI, Canister API, and agent skill workflows.",
  openGraph: {
    title: "Kinic Wiki Docs",
    description: "Documentation for Kinic Wiki Clipper, CLI, Canister API, and agent skill workflows."
  },
      ...
      <div className="flex flex-col gap-6">
        <AdminPanel className="min-w-0" padding="lg">
          ...
          <p className="mt-3 max-w-3xl text-sm leading-6 text-muted">
            Guides for browser capture, CLI automation, direct canister calls, and agent workflow skills. Use these pages to move evidence into Kinic Wiki and maintain it safely.
          </p>
        </AdminPanel>

        <section className="grid gap-4 md:grid-cols-2 xl:grid-cols-4" aria-label="Primary docs">
          {primaryDocs.map((doc) => (
