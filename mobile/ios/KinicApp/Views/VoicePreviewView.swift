...
struct VoicePreviewView: View {
    ...
    private let consentVersion = "2026-09-22"
            ...
            ScrollView {
                VStack(alignment: .leading, spacing: 24) {
                    ...
                    if needsConsent, let access {
                        Text("Your questions, selected target, and up to six recent conversation messages (up to 4,000 characters) will be sent to TypeSafe for intent classification. Necessary Wiki paths and previews will also be sent for search ranking. Questions, microphone audio, and relevant Wiki excerpts will be sent to OpenAI. Both providers process data in the United States.")
