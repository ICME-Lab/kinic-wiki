...
struct VFSCandidTypesTests {
    ...
    func allVFSRepliesDecodeFromDIDGoldens() throws {
        ...
        let billingWithoutIAP: VFSCandidResult<CyclesBillingConfig, String> = try decoded(Fixtures.billingWithoutIAP)
        #expect(try billingWithoutIAP.textValue().iapAuthorityId == nil)
        ...
        #expect(try cycleEntries.textValue().entries.first?.voiceSessionId == "voice-example")
        #expect(try cycleEntries.textValue().entries.first?.voiceSeconds == 12)
        #expect(try cycleEntries.textValue().entries.first?.voiceRateVersion == 1)
        ...
        let mutations: VFSCandidResult<[VFSNodeMutationResult], VFSNodeMutationFailure> = try decoded(Fixtures.mutateNodesBatch)
        let outcomes = try mutations.mutationValue().map(\.outcome)
        #expect(outcomes.count == 2)
        #expect(outcomes[0] == .madeDirectory(created: true, path: "/WorkItems"))
        #expect(outcomes[1] == .wrote(
            created: true,
            node: VFSNodeMutationAck(path: "/WorkItems/a/item.md", kind: .file, updatedAt: 20, etag: "etag-1")
        ))
    }
...
private enum Fixtures {
    ...
    static let billing = "4449444c046b02bc8a0101c5fed201716c069bd0eaec03719e8f87f80302d281d496087185c2c2a90903d6dfcfab09789682a6b10a786e716c038189c4f1077ee1fc9cc3087dcf9f9ff10c710100000762696c6c696e670103696170066c656467657201e8070861616161612d616114000000000000001e00000000000000"
    static let billingWithoutIAP = "4449444c046b02bc8a0101c5fed201716c069bd0eaec03719e8f87f80302d281d496087185c2c2a90903d6dfcfab09789682a6b10a786e716c038189c4f1077ee1fc9cc3087dcf9f9ff10c710100000762696c6c696e6700066c656467657201e8070861616161612d616114000000000000001e00000000000000"
    ...
    static let cycleEntries = ""
    ...
    static let mutateNodesBatch = ""
    ...
    static let billingOverflow = ""
}
