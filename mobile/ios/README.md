...
- Stores Ask AI conversation history on the device. Questions and bounded excerpts from retrieved documents are sent to `https://api.kinic.io/chat` to generate grounded answers.
