...
kinic-vfs-cli --database-id <database-id> curator apply --plan wiki.curator-plan.json --proposal <id>
kinic-vfs-cli --database-id <database-id> curator apply --plan wiki.curator-plan.json --proposal <id> --confirm
```
