/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=PaymentBindings` (hash: c11566d8639e460934e7e9b764a01b37)
...
interface __BaseEnv_PaymentBindings {
	...
	IAP_PRODUCT_CATALOG_JSON: "{\"xyz.kinic.dbcredits.small\":\"2000000000000\",\"xyz.kinic.dbcredits.medium\":\"1200000000000\",\"xyz.kinic.dbcredits.large\":\"4000000000000\"}";
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "KINIC_WIKI_CANISTER_ID" | "KINIC_WIKI_IC_HOST" | "APP_STORE_ENVIRONMENT" | "APP_STORE_BUNDLE_ID" | "APP_STORE_NOTIFICATION_ROOT_SHA256" | "IAP_PRODUCT_CATALOG_JSON">> {}
}
