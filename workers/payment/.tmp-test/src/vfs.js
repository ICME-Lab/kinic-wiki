...
export async function grantDatabaseCyclesFromIap(env, request) {
    ...
    const idlFactory = ({ IDL: idl }) => {
        ...
        return idl.Service({
            grant_database_cycles_from_iap: idl.Func([DatabaseCyclesIapGrantRequest], [idl.Variant({ Ok: CyclesPurchaseResult, Err: idl.Text })], [])
        });
    };
