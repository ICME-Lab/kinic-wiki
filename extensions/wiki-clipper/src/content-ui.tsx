      ...
      <div class="recall-card-actions">
        ...
        {result.sourceUrl ? (
          <a
            ...
            aria-label={`Open ${result.title} in WikiBrowser`}
          >
            Open in Wiki <span aria-hidden="true">↗</span>
          </a>
        ) : null}
      </div>
    </article>
