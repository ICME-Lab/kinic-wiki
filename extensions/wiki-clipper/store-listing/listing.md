# Kinic Wiki Clipper Store Listing

## Short description

Save web pages and ChatGPT, Claude, and Gemini conversations into a Kinic Wiki database.

## Detailed description

Kinic Wiki Clipper sends the current page URL or selected ChatGPT, Claude, and Gemini conversations to a Kinic Wiki database that you can write to.
