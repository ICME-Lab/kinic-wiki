...
Save web pages and ChatGPT/Claude conversations into a Kinic Wiki database.

## Detailed description

Kinic Wiki Clipper sends the current page URL or selected ChatGPT/Claude conversations to a Kinic Wiki database that you can write to.
