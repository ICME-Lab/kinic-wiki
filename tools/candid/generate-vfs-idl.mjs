...
const typeOrder = [
  ...
  "ResultLinks",
  "ResultNodeContext",
  "ResultNodePublication",
  "ResultOptionalNodePublication",
  "ResultPublicNode",
  "ResultSearch",
  "ResultQueryContext",
...
const methodOrder = [
  ...
  "get_initial_free_database_grant_status",
  "get_node_publication",
...
function renderVfsIdl() {
  const lines = [
    "// Generated by tools/candid/generate-vfs-idl.mjs from crates/vfs_canister/vfs.did.",
    "// Do not edit by hand.",
