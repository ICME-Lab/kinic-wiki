export const expectedTypes = {
  ...
  DatabaseCycleEntry: {
    kind: "record",
    fields: {
      voice_session_id: "opt text",
      voice_seconds: "opt nat64",
      voice_rate_version: "opt nat64",
      method: "opt text",
...
export const didTypeAliases = {
  ...
  ResultLinks: "Result_18",
  ResultChildren: "Result_19",
  ResultCyclesEntries: "Result_20",
  ResultCyclesPendingPurchases: "Result_21",
  ResultMembers: "Result_22",
  ResultDatabases: "Result_23",
  ResultNat64: "Result_25",
  ResultMarketListing: "Result_26",
  ResultMarketListingDetail: "Result_27",
  ResultMarketEntitlementPage: "Result_28",
  ResultMarketListings: "Result_29",
  ResultMarketListingPage: "Result_30",
  ResultMarketOrderPage: "Result_31",
  ResultMarketPurchasePreview: "Result_32",
  ResultMarketOrder: "Result_33",
  ResultMemoryManifest: "Result_34",
  ResultMkdirNode: "Result_35",
  ResultMoveNode: "Result_36",
  ResultNodePublication: "Result_38",
  ResultCyclesPurchase: "Result_17",
  ResultQueryContext: "Result_39",
  ResultIndexSqlJsonQuery: "Result_40",
  ResultNode: "Result_41",
  ResultNodeContext: "Result_42",
  ResultPublicNode: "Result_43",
  ResultSearch: "Result_45",
  ResultStorageBillingBatch: "Result_46",
  ResultSourceEvidence: "Result_47",
  ResultUnit: "Result_1",
  ResultWriteNode: "Result",
  ResultWriteNodes: "Result_51",
  ResultDatabaseMetadata: "Result_48",
  ResultWikiMetrics: "Result_49",
  ResultWikiMetricsSeries: "Result_50",
  ResultWriteSourceForGeneration: "Result_52"
};
