...
Use [`MAINNET_TESTFLIGHT_RELEASE.md`](MAINNET_TESTFLIGHT_RELEASE.md) for the full mainnet Worker/canister and iOS TestFlight release path.
...
- `kinic-vfs-cli-v2.0.1-linux-x86_64.tar.gz`
- `kinic-vfs-cli-v2.0.1-linux-x86_64.sha256`
- `kinic-vfs-cli-v2.0.1-macos-arm64.tar.gz`
- `kinic-vfs-cli-v2.0.1-macos-arm64.sha256`
...
```bash
shasum -a 256 -c kinic-vfs-cli-v2.0.1-macos-arm64.sha256
tar -xzf kinic-vfs-cli-v2.0.1-macos-arm64.tar.gz
./kinic-vfs-cli --help
