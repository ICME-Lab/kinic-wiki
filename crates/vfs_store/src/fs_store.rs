...
impl FsStore {
    ...
    /// Single transaction entry point for mutations that publish history.
    /// The callback is responsible only for node mutation; this method owns the
    /// begin/finish/finalize ordering and publication commit record.
